...
def run_acoustic_test(fs: int = 48000, device_in: int = None, device_out: int = None):
    # Configuration
    ...
    try:
        ...
        if decoded_payload:
            try:
                ...
                logger.info(f"SUCCESS! Decoded Raw: {decoded_payload}")
        else:
        ...
        logger.info("Ensure 'sounddevice' is installed (pip install sounddevice) and a mic/speaker is active.")
